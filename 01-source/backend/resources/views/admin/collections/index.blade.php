...
<div class="container">
        <div class="row page-title-row">
            <div class="col-md-6">
            <!-- 改 -->
                <h3>collections index
                    <small>» collections</small>
                </h3>
            </div>
            <div class="col-md-6 text-right">
            <!-- 改 -->
                <a href="/admin/collections/create" class="btn btn-success btn-md">
        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                @include('admin.collections.errors')
                @include('admin.collections.success')
                <table id="tags-table" class="table table-striped table-bordered">
                    ...
                    @foreach ($data as $tag)
                        <tr>
                            ...
                            <td>
                            <!-- 改 -->
                                <a href="/admin/collections/{{ $tag->id }}/edit" class="btn btn-xs btn-info">
